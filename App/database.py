...
######################################################################
  ...
  keemon = Digimon(name="Keemon", level="Baby", next_form=["Yaamon"], bio="Keemon is a Slime Digimon. It is an evil-eyed Digimon which is always scowling. Though it's very young, it hates being crowded by others, and lives in hiding. It likes poking its nose out of hiding and harassing with its 'Pushū'.", photo_url="https://digicyclopedia.s3.us-east-2.amazonaws.com/Digimon/Baby/Keemon_b.jpg")
